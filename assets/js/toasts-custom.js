...
document.querySelector("#basicToastBtn, #basicToastBtn1").onclick = function() {
	new bootstrap.Toast(document.querySelector('#basicToast , #basicToast2, #selectToastPlacement',  )).show();
   }
   
// document.querySelector("#basicToastBtn1").onclick = function() {
// 	new bootstrap.Toast(document.querySelector('#basicToast1')).show();
// }
